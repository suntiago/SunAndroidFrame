...
/**
 * Created by yu.zai on 2016/4/7.
 */
public class FaceMap {
    private static FaceMap faceMapInstance;
    private static Map<String, Integer> mFaceMap = new LinkedHashMap<String, Integer>();
    public static FaceMap getInstance() {
        if (faceMapInstance == null) {
            faceMapInstance = new FaceMap();
        }
        return faceMapInstance;
    }
